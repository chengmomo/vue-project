<template>
  <div class="form-container">
    <el-row>
      <el-col :span="18">
        <el-form :model="ruleForm" :rules="rules" :inline="false" ref="ruleForm"
                 label-width="90px" label-position="right"
                 class="demo-ruleForm" status-icon @submit.native.prevent>
          ...
          <el-form-item label="评分" prop="rate">
            <el-rate v-model="ruleForm.rate" show-text :colors="['#99A9BF', '#F7BA2A', '#FF9900']"
    ...
    <back-top :visibilityHeight="120"></back-top>
  </div>
</template>
<script>
