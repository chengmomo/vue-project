		...
		<el-container> 
			<el-header class="el-header-demo">
				...
				<el-col :span="16" class='menu-container'>
					<el-menu theme="dark" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b"class="el-menu-demo" mode="horizontal" :default-active="$store.state.headerCurRouter"  unique-opened router>
						<el-menu-item v-for='(item,index) in $router.options.routes' :index="item.path" :key='item.path' v-if='!item.hidden' class="el-menu-item-demo"  @click="menuClick(item.path)">
				...
				<el-col :span="4" class='user-container'>
					...
					<el-dropdown trigger="click" menu-align="start" @command='setDialogInfo' class="animated fadeIn">
						<span class="el-dropdown-link">
							zhaichengjuan<!-- <i class="el-icon-arrow-down el-icon--right"></i> -->
						</span>
