<template>
	<section>
		<el-table ref="multipleTable" :data="tableData" border stripe  max-height="650"  height="650" style="width: 80%;text-align: center;" header-cell-style="text-align: center;" :row-class-name="tableRowClassName" tooltip-effect="dark" @selection-change="handleSelectionChange" >
